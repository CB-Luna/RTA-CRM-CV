...
class TrapecioRojo extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint_0_fill = Paint()..shader = ui.Gradient.linear(const Offset(0, 0), const Offset(150, 0), <Color>[const ui.Color.fromARGB(255, 213, 96, 87), const Color(0xffBF2135)]);
