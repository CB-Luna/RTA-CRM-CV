...
class TrapecioGris extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint_0_fill = Paint()..shader = ui.Gradient.linear(const Offset(0, 0), const Offset(150, 0), <Color>[const ui.Color.fromARGB(255, 249, 248, 248), const Color(0xffE6E6E6)]);
