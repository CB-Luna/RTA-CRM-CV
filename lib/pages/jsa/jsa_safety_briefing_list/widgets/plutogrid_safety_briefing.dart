...
class PlutoGridSafetyBriefing extends StatefulWidget {
  const PlutoGridSafetyBriefing({required this.iDJSA, super.key});
  final int iDJSA;
  @override
  State<PlutoGridSafetyBriefing> createState() =>
      _PlutoGridSafetyBriefingState();
}

class _PlutoGridSafetyBriefingState extends State<PlutoGridSafetyBriefing> {
  @override
