...
class PdfPopUpSafetyBriefing extends StatefulWidget {
  final String name;
  const PdfPopUpSafetyBriefing({required this.name, super.key});

  @override
  State<PdfPopUpSafetyBriefing> createState() => PdfPopUpSafetyBriefingState();
}

class PdfPopUpSafetyBriefingState extends State<PdfPopUpSafetyBriefing> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final JsaSafetyProvider provider = Provider.of<JsaSafetyProvider>(context);
