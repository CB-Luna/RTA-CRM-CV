...
class DownloadAPKJSAPageMobile extends StatefulWidget {
  const DownloadAPKJSAPageMobile({super.key});

  @override
  State<DownloadAPKJSAPageMobile> createState() => _DownloadAPKJSAPageMobileState();
}

class _DownloadAPKJSAPageMobileState extends State<DownloadAPKJSAPageMobile> {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                height: 30,
                                child: Text('Download JSA APK', style: AppTheme.of(context).title2),
                              ),
                            ),
                          ],
                        ),
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsetsDirectional.fromSTEB(
                                                          0, 0, 0, 30),
                                                  child: Text(
                                                    "Click on 'Download' to redirect to the JSA APK.",
                                                        ...
                                                        showDialog(
                                                          ...
                                                          builder: (builder) {
                                                            return AlertDialog(
                                                              ...
                                                              title: const Text('Allow Download JSA.'),
                                                              content: const Text('Are you sure you want to download JSA APK?'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () async {
                                                                    final html = window.navigator.userAgent.toLowerCase();
                                                                    if (html.contains("android")) {
                                                                      await launchInBrowser(urlJSAAPK);
                                                                    } else {
                                                                      fToast.showToast(
                                                                        child: const WarningToast(
                                                                          message: "The actual device\ndon't support JSA APK download",
                                                                        ),
