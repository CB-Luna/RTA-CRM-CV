...
class RiskMatrixPopup extends StatefulWidget {
  final Function(String, String) onRiskSelected;

  const RiskMatrixPopup({super.key, required this.onRiskSelected});

  @override
  _RiskMatrixPopupState createState() => _RiskMatrixPopupState();
}

class _RiskMatrixPopupState extends State<RiskMatrixPopup> {
    ...
    builder: (BuildContext context) {
      return RiskMatrixPopup(
        onRiskSelected: (selectedLikelihood, selectedConsequence) {
          ...
          jsaProvider.setRiskLevel(riskLevel, stepId);
        },
      );
    },
  );
