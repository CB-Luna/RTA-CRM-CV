              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    stops: const [0.1, 0.6],
                    colors: [
                      AppTheme.of(context).primaryColor.withOpacity(1),
                      Colors.white,
                    ],
                  ),
                          ...
                          children: [
                            ...
                            Center(
                              child: Container(
                                ...
                                decoration: BoxDecoration(color: AppTheme.of(context).cryPrimary, borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.white, width: 2)),
                                child: const Center(
                                    child: Text("CRY",
                                        style: TextStyle(
                                          color: Colors.white,
                            ...
                            children: [
                              ...
                              Center(
                                child: Container(
                                  width: MediaQuery.of(context).size.width * 0.03,
                                  height: MediaQuery.of(context).size.height * 0.05,
                                  decoration: BoxDecoration(color: AppTheme.of(context).odePrimary, borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.white, width: 2)),
                                  child: const Center(
                                      child: Text("ODE",
                                          style: TextStyle(
                                            color: Colors.white,
                          ...
                          children: [
                            ...
                            Center(
                              child: Container(
                                width: MediaQuery.of(context).size.width * 0.03,
                                height: MediaQuery.of(context).size.height * 0.05,
                                decoration: BoxDecoration(color: AppTheme.of(context).smiPrimary, borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.white, width: 2)),
                                child: const Center(
                                    child: Text("SMI",
                                        style: TextStyle(
                                          color: Colors.white,
