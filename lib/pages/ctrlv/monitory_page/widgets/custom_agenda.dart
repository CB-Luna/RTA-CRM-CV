                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Container(
                                                  width: 400,
                                                  height: 79,
                                                  decoration: BoxDecoration(color: AppTheme.of(context).odePrimary),
                                                ),
                                              ],
                                            ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: ShapeDecoration(
                                                      color: AppTheme.lightTheme.tertiaryColor.withOpacity(0.5),
                                                      shape: RoundedRectangleBorder(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      width: 400,
                                                      height: 79,
                                                      decoration: BoxDecoration(color: AppTheme.of(context).cryPrimary),
                                                    ),
                                                  ],
                                                ),
                                                Column(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        Container(
                                                          width: 400,
                                                          height: 79,
                                                          decoration: BoxDecoration(color: AppTheme.of(context).smiPrimary),
                                                        ),
                                                      ],
                                                    ),
                                                    Column(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Opacity(
                                                          opacity: 0.65,
                                                          child: Text(
                                                            DateFormat('hh:mm:ss a').format(provider.idEventos[index].dateAddedD!),
                                                            style: const TextStyle(
                                                              color: Color.fromRGBO(245, 6, 213, 1),
                                                              fontSize: 12,
                                                              fontFamily: 'Poppins',
