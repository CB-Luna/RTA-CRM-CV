...
//   const MonitoryPage({Key? key}) : super(key: key);
...
//           tablet: (BuildContext context) => MonitoryPageDesktop(key: UniqueKey(), drawerController: drawerController, scaffoldKey: scaffoldKey, provider: provider),
//           desktop: (BuildContext context) => MonitoryPageDesktop(key: UniqueKey(), drawerController: drawerController, scaffoldKey: scaffoldKey, provider: provider),
