...
class TrapecioGris extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..shader = ui.Gradient.linear(const Offset(0, 0), const Offset(150, 0), <Color>[const Color.fromRGBO(255, 138, 0, 0.9), const Color.fromRGBO(255, 138, 0, 1)]);
