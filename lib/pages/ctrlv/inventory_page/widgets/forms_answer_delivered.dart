...
class AnswerFormDeliveredInventory extends StatelessWidget {
  const AnswerFormDeliveredInventory({super.key});
      ...
      child: Row(
        ...
        children: [
          ...
          DetailControlForm(
            ...
            state: provider.fluidCheckInspectD,
            index: 4,
            provider: provider,
          ...
          DetailControlForm(
            ...
            state: provider.securityInspectD,
            index: 6,
            provider: provider,
            list: provider.securityD,
          ),
          DetailControlForm(
            title: "Extra",
            icon: Icons.more_outlined,
            state: provider.extraInspectD,
            index: 7,
            provider: provider,
            list: provider.extraD,
          ),
          DetailControlForm(
            title: "Equipment",
            icon: Icons.home_repair_service_outlined,
            state: provider.equipmentInspectD,
            index: 8,
            provider: provider,
            list: provider.equipmentD,
          ),
        ],
      ),
    );
