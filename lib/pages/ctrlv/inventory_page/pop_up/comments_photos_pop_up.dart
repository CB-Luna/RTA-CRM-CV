        ...
        Row(
          ...
          children: [
            Container(
              ...
              child: Text(
                isssueReportedProvider.registroIssueComments?.dateAdded == null ? "No Date" : DateFormat("MMM/dd/yyyy").format(isssueReportedProvider.registroIssueComments!.dateAdded),
                style:
                    TextStyle(color: AppTheme.of(context).contenidoTablas.color, fontFamily: 'Bicyclette-Thin', fontSize: AppTheme.of(context).contenidoTablas.fontSize, fontWeight: FontWeight.bold),
              ),
            ),
            Container(
              padding: const EdgeInsets.all(15.0),
              ...
              child: Text(
                isssueReportedProvider.registroIssueComments?.nameIssue == null ? "No Issue" : isssueReportedProvider.registroIssueComments!.nameIssue.capitalize.replaceAll("_", " "),
                style:
                    TextStyle(color: AppTheme.of(context).contenidoTablas.color, fontFamily: 'Bicyclette-Thin', fontSize: AppTheme.of(context).contenidoTablas.fontSize, fontWeight: FontWeight.bold),
              ),
            ),
          ...
          children: [
            Column(
              children: [
                Container(
                  ...
                  child: SingleChildScrollView(child: Text("${isssueReportedProvider.registroIssueComments?.comments}.")),
                ),
                Padding(
            ...
            SizedBox(
              ...
              child: CarouselSlider.builder(
                itemCount: isssueReportedProvider.registroIssueComments?.listImages == null ? 0 : isssueReportedProvider.registroIssueComments?.listImages?.length,
