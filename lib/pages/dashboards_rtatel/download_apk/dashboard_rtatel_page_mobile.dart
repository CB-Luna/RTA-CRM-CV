...
class DashboardRtatelPageMobile extends StatefulWidget {
  const DashboardRtatelPageMobile({super.key});

  @override
  State<DashboardRtatelPageMobile> createState() => _DashboardRtatelPageMobileState();
}

class _DashboardRtatelPageMobileState extends State<DashboardRtatelPageMobile> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(
                                height: 30,
                                child: Text('Dashboard RTATEL', style: AppTheme.of(context).title2),
                              ),
                            ),
                          ],
                        ),
