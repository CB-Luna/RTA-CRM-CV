...
class TowersDesktop extends StatefulWidget {
  const TowersDesktop({super.key});

  @override
  State<TowersDesktop> createState() => _TowersDesktopState();
}

class _TowersDesktopState extends State<TowersDesktop> {
          ...
          child: Container(
            ...
            child: CustomCard(
              title: provider.nameController == null
                  ? "Tower "
                  : "Tower - ${provider.nameController.text}",
