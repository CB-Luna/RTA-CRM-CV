...
class CircuitsEditDesktop extends StatefulWidget {
  const CircuitsEditDesktop({super.key});

  @override
  State<CircuitsEditDesktop> createState() => _CircuitsEditDesktopState();
}

class _CircuitsEditDesktopState extends State<CircuitsEditDesktop> {
                ...
                children: [
                  ...
                  CustomCard(
                    title: provider.cktIDController == null
                        ? "Edit Circuit "
                        : "Editing Circuit - ${provider.cktIDController.text}",
