...
class EditCircuitPopUp extends StatefulWidget {
  const EditCircuitPopUp({super.key});

  @override
  State<EditCircuitPopUp> createState() => _EditCircuitPopUpState();
}

class _EditCircuitPopUpState extends State<EditCircuitPopUp> {
            ...
            if (provider.indexSelected[3])
              CustomTextIconButton(
                  ...
                  onTap: () async {
                    ...
                    bool res = await provider.updateCircuit();
