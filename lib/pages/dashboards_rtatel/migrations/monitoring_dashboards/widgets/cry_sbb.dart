...
class CRYSBB extends StatefulWidget {
  const CRYSBB({super.key});

  @override
  State<CRYSBB> createState() => _CRYSBBState();
}

class _CRYSBBState extends State<CRYSBB> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration:
          BoxDecoration(color: const Color(0xff793FAD), border: Border.all()),
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  border: Border.symmetric(
                      horizontal:
                          BorderSide(color: Color(0xff8430CE), width: 6)),
                ),
