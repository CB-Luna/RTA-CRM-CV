...
class EASTXOL extends StatefulWidget {
  const EASTXOL({super.key});

  @override
  State<EASTXOL> createState() => _EASTXOLState();
}

class _EASTXOLState extends State<EASTXOL> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration:
          BoxDecoration(color: const Color(0xff749A4B), border: Border.all()),
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  border: Border.symmetric(
                      horizontal:
                          BorderSide(color: Color(0xff7CB342), width: 6)),
                ),
                child: const Text("EAS/TXOL",
                    style: TextStyle(
