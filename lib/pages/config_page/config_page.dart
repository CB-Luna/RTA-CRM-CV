...
import 'package:rta_crm_cv/pages/config_page/widgets/image_selection_panel_login.dart';
...
class _ConfigPageState extends State<ConfigPage> {
  ...
  bool isLoginPicturesLoginSelectionOpen=true;
                                    ...
                                    children: <Widget>[
                                      Material(
                                        ...
                                        child: ListTile(
                                          ...
                                          trailing: ExpandIcon(
                                            size: 32,
                                            isExpanded: isLoginPicturesLoginSelectionOpen,
                                            padding: EdgeInsets.zero,
                                            onPressed: (_) {
                                              setState(() => isLoginPicturesLoginSelectionOpen = !isLoginPicturesLoginSelectionOpen);
                                            },
                                          ),
                                          onTap: () {
                                            setState(() => isLoginPicturesLoginSelectionOpen = !isLoginPicturesLoginSelectionOpen);
                                      ...
                                      AnimatedSwitcher(
                                        ...
                                        child: (isLoginPicturesLoginSelectionOpen) ? const ImageSelectionPanelLogIn() : const SizedBox.shrink(),
                                      ),
                                    ],
                                  ),
                                ),
