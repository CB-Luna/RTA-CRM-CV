...
import 'package:rta_crm_cv/providers/employees_provider/add_employees_provider.dart';
...
class _AddUserPopUpState extends State<AddUserPopUp> {
  ...
  Widget build(BuildContext context) {
    AddEmployeesProvider provider = Provider.of<AddEmployeesProvider>(context);
    return AlertDialog(
