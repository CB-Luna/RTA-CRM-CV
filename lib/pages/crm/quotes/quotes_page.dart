                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: TabBar(
                                        ...
                                        tabs: [
                                          const Tab(text: 'All'),
                                          Tab(text: provider.listStatus[provider.listStatus.indexWhere((status) => status.id == 1)].name),
                                          const Tab(text: 'Validate'),
                                          const Tab(text: 'Canceled'),
                                          Tab(text: provider.listStatus[provider.listStatus.indexWhere((status) => status.id == 6)].name),
                                          Tab(text: provider.listStatus[provider.listStatus.indexWhere((status) => status.id == 7)].name),
                                          Tab(text: provider.listStatus[provider.listStatus.indexWhere((status) => status.id == 8)].name),
