...
class Vehicle {
  ...
  factory Vehicle.fromMap(Map<String, dynamic> json) => Vehicle(
      ...
      registrationDue: DateTime.parse(json["transmission_fluid_change"]),
      renewalInsDue: DateTime.parse(json["radiator_fluid_change"]));
  ...
  Map<String, dynamic> toMap() => {
        ...
        "transmission_fluid_change": registrationDue.toIso8601String(),
        "radiator_fluid_change": renewalInsDue.toIso8601String()
      };
}
